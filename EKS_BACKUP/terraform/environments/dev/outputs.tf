...
output "ecr_repository_url" {
  ...
  value       = module.addons.ecr_repository_url
}

output "ecr_repository_name" {
  description = "Name of the ECR repository"
  value       = module.addons.ecr_repository_name
}
...
output "argocd_access_instructions" {
  ...
  value = <<-EOT
    To access ArgoCD (Dev Environment):
    ...
    4. Application: nest-wallet-dev (single dev environment)
  EOT
}
